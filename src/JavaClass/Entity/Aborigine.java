...
public class Aborigine extends Entity {
    ...
    private void InitProperties() {
        isLeft = true;
        isRight = false;
        localPosition = new Vector2(2455, 450);
        globalPosition = new Vector2(2455, 450);
    ...
    private void UpdateLeftRightBoolean() {
        ...
        if (updatedPosition.x > 2555 && isRight) {
            isLeft = true;
            isRight = false;
        } else if (updatedPosition.x < 2355 && isLeft) {
            isRight = true;
            isLeft = false;
        }
    }
